...
/* NativeWindow Access ***********************************************************/
  ...
  /*Note: we use a dummy value here rather than adding a hard dependency on gtk for
    ...
    Dependencies can be added via $(pkg-config --cflags --libs gtk+-2.0) if using AIR 51.1 and below,
    or for AIR 51.2 onwards please use $(pkg-config --cflags --libs gtk+-3.0) */
...
FREResult FREGetNativeContext3DHandle(
	FREObject        context3D,
	void**           handle
);
